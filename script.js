window.addEventListener("load", function () {
  ...
  class Explosion {
    constructor(game, x, y) {
      ...
      this.spriteWitdh = 200;
      this.width = this.spriteWitdh;
  ...
  class Game {
    constructor(width, height) {
      ...
      this.explosions = [];
      this.enemyTimer = 0;
      this.enemyIterval = 2000;
      this.ammo = 20;
      this.maxAmmo = 50;
      this.ammoTimer = 0;
      this.ammoIterval = 350;
      this.gameOver = false;
      this.score = 0;
      this.winnigScore = 80;
      this.gameTime = 0;
    ...
    update(deltaTime) {
      ...
      if (this.ammoTimer > this.ammoIterval) {
      ...
      if (this.enemyTimer > this.enemyIterval && !this.gameOver) {
        this.addEnemy();
        this.enemyTimer = 0;
      } else {
